...
from app.pb import auth_pb2 as auth__pb2
...
class AuthServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Login = channel.unary_unary(
                '/neighborhood.library.v1.AuthService/Login',
...
def add_AuthServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'neighborhood.library.v1.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('neighborhood.library.v1.AuthService', rpc_method_handlers)
